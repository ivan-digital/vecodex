...
// +kubebuilder:rbac:groups=apps.vecodex.link,resources=vecodexsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.vecodex.link,resources=vecodexsets/status,verbs=get;update;patch
